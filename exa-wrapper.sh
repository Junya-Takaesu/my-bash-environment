...
# exa のオプションの挙動を ls に似せるためのラッパースクリプト
# THIS CRIPT IS COPIED FROM https://gist.github.com/eggbean/74db77c4f6404dd1f975bd6f048b86f8
...
# ここが、exa のコマンド実行箇所
# オプションとか付け足したり、取り除いたりはここでする
exa --color-scale --icons --header --time-style=long-iso "${exa_opts[@]}" "$@"
